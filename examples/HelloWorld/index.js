	...
	main: A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A3(_user$project$AFrame_Primitives_Attributes$position, 0, 1.25, -1),
						_user$project$AFrame_Primitives_Attributes$radius(1.25),
						_user$project$AFrame_Primitives_Attributes$color(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A3(_user$project$AFrame_Primitives_Attributes$position, -1, 0.5, 1),
						_user$project$AFrame_Primitives_Attributes$radius(0.5),
						_user$project$AFrame_Primitives_Attributes$width(1),
						_user$project$AFrame_Primitives_Attributes$height(1.5),
						_user$project$AFrame_Primitives_Attributes$depth(1),
						_user$project$AFrame_Primitives_Attributes$color(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A3(_user$project$AFrame_Primitives_Attributes$position, 1, 0.75, 1),
						_user$project$AFrame_Primitives_Attributes$radius(0.5),
						_user$project$AFrame_Primitives_Attributes$height(1.5),
						_user$project$AFrame_Primitives_Attributes$color(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$AFrame_Primitives_Attributes$width(4),
						_user$project$AFrame_Primitives_Attributes$height(4),
						_user$project$AFrame_Primitives_Attributes$color(
